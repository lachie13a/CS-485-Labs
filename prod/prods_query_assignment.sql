...
SELECT invoice_num FROM invoice WHERE invoice_date = '13-SEP-07' AND cust_id = '1619';
...
SELECT prod_id, prod_desc FROM product WHERE prod_quantity >= 12 AND prod_quantity <= 30;
SELECT prod_id, prod_desc FROM product WHERE prod_quantity BETWEEN 12 AND 30;
